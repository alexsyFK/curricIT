...
static File fi;   
static int anons_int=-1;
//static String pa;
 //ImageIcon  anon=new ImageIcon(getClass().getResource("/classes/anonn.png"));
  static ImageIcon  anon;
  ImageIcon  anons=new ImageIcon(getClass().getResource("/classes/anonn.png"));
...
//else{
//    anonymous=anon.getImage().getScaledInstance(jL_img.getWidth(), jL_img.getHeight(), Image.SCALE_DEFAULT);
//    imx3[xp]=new ImageIcon(anonymous);
//jL_img.setIcon(anon);

//imx[xp].setImage(anon);//=anon=new ImageIcon(getClass().getResource("/classes/anonn.png").getImage().getScaledInstance(jL_img.getWidth(), jL_img.getHeight(), Image.SCALE_DEFAULT));
        //.getScaledInstance(jL_img.getWidth(), jL_img.getHeight(), Image.SCALE_DEFAULT));
//}
